...
const SendUploadGuides = {
    category: 'Tags',
    data: new discord_js_1.ContextMenuCommandBuilder().setName('Send upload guides').setType(discord_js_1.ApplicationCommandType.User),
    async execute(interaction) {
        ...
        if (!guides.embeds)
            return await interaction.reply({
                content: 'This guide is not available anymore.',
                ephemeral: true,
            });
