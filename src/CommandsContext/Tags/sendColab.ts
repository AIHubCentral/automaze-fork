import { ApplicationCommandType, ColorResolvable, ContextMenuCommandBuilder, EmbedBuilder, InteractionReplyOptions } from 'discord.js';
...
const SendColabGuides: ContextCommand = {
    ...
    async execute(interaction) {
        ...
        const botResponse: InteractionReplyOptions = {
            content: `Colab suggestions for ${targetUser.toString()}`, embeds: embeds
        };
