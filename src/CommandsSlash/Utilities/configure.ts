import {
	...
	EmbedBuilder, heading, HeadingLevel, codeBlock, ChatInputCommandInteraction,
	PresenceStatusData, InteractionReplyOptions, inlineCode, unorderedList, Colors, userMention, bold
}
	from 'discord.js';
...
async function configureCommision(interaction: ChatInputCommandInteraction, configs: IBotConfigs): Promise<void> {
